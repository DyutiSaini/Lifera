...
import "../styles/Donate.css"; // you had `/src/styles/Donate.css`, make sure path is correct
import { FaHeart } from "react-icons/fa";
import { SiGooglemaps } from "react-icons/si"; // Si = Simple Icons
import { Heart, Clock, Activity, Award } from "lucide-react";
import { Calendar, Scale, HeartPulse, ShieldCheck, Scissors, RefreshCcw } from "lucide-react"; // ✅ icons
  ...
  return (
    <main className="donate-page">
      ...
      <section className="donate-hero">
        ...
        <button class="btn1 register1" onclick="registerDonor()" backgroun><div style={{ fontSize: "40px", color: "white", outline:"red" ,stroke:"1rem"}}><FaHeart />  </div> Register as Donor</button>
        <button class="btn1 find1" onclick="findCenters()"><div style={{ fontSize: "40px", color: "white" }}><SiGooglemaps />  </div> Find Nearby Centers</button>
         </div>
        </div>
      </section>
  ...
  <div className="donation-container">
      ...
      <section className="safe-donation">
        ...
        <div className="post-donation">
          ...
          <ul>
            <li>Stay hydrated – drink plenty of fluids for the next 24 hours.</li>
      ...
      <section className="stories">
        ...
        <div className="story-cards">
          ...
          <div className="story-card">
            <p>
              “The process is smooth and efficient. Highly recommend donating!”
            </p>
            <h4>Ananya Singh</h4>
            <span>NGO Volunteer</span>
          </div>
          <div className="story-card">
            <p>“It’s so easy to register and donate — everyone should do it!”</p>
            <h4>Priya Sharma</h4>
      ...
      <section className="contact">
        <div className="contact-box">
          ...
          <div className="but">
           ...
           <p className="footer-text">© 2025 Lifera. Donate Blood. Save Lives.</p>
